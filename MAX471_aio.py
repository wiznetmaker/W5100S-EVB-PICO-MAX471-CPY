...
# Feed Name
voltage_feed = "meter.voltage"
current_feed = "meter.current"
power_feed = "meter.power"
...
while True:
    ...
    power = meter.Power()
    print (("{} mW").format(power))
    io.publish_multiple([(voltage_feed, voltage), (current_feed, current),(power_feed, power)])
